// Figma node: 301:7915 (Navigation) — Type=Default / Type=Briefing
// 화면 상단의 뒤로가기 + 타이틀 + 더보기 구조의 공용 네비게이션 바입니다.

import type { ReactNode } from "react";

const imgChevronLeft =
  "https://www.figma.com/api/mcp/asset/89747008-d619-4f8f-9182-37dc5318b7b6.svg";
const imgMoreVerticalVector =
  "https://www.figma.com/api/mcp/asset/15fd7d8b-b216-4100-8c9d-5a27b8e70cc4.svg";

function MoreVerticalIcon({ className }: { className?: string }) {
  return (
    <div className={className || "overflow-clip relative size-[24px]"} data-name="more-vertical">
      <div className="absolute inset-[45.83%]">
        <div className="absolute inset-[-50%]">
          <img alt="" className="block max-w-none size-full" src={imgMoreVerticalVector} />
        </div>
      </div>
