...
const imgMicIcon = "https://www.figma.com/api/mcp/asset/b240f773-5f01-4387-aae4-e4de6b4aae9c.svg";
const imgRouteIcon = "https://www.figma.com/api/mcp/asset/73ba59b1-69d5-4c8a-93f8-b212dbae2bc4.svg";

export type BottomCTAType = "Single" | "Briefing" | "Route" | "Split" | "VoiceConfirm";
      ...
      {type === "Single" && (
        <button
          ...
          className={`flex items-center justify-center p-[16px] rounded-[var(--radius-button-lg)] shrink-0 w-full ${
            enabled ? "bg-[var(--color-action-primary)]" : "bg-[var(--color-gray-400)]"
          }`}
        >
